...
pub fn make_russ_org_principal(
    session: &ActiveSession,
    data: &NewMchdData
...
pub fn make_root_manager_wrap_person(
    data: &NewMchdData
) -> WrapPerson {
...
pub fn make_root_manager_person_mchd(
    data: &NewMchdData
) -> PersonMchd {
