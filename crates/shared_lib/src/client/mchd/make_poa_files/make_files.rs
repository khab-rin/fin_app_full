...
use crate::client::sql_queries::persons::insert::person_no_sync::insert_person_no_sync;
use crate::client::mchd::make_poa_elems::poa::make_poa;
use crate::client::mchd::make_poa_files::make_doc_file::add_doc_to_xml_file;


pub async fn make_xml_doc_files(
    state: &ClientState,
    data: &NewMchdData
